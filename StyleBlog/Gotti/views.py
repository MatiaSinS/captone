...
def cancelar_pedido(request):
    if request.method == 'POST':
        ...
        for carrito_id in seleccionados:
            ...
            if carrito.confirmado:
                messages.error(request, f"El pedido con ID {carrito_id} ya ha sido confirmado y no se puede cancelar.")
                continue
            ...
            try:
                ...
                messages.success(request, f"El pedido con ID {carrito_id} ha sido cancelado y se ha enviado un correo a {carrito.cliente.nombre}.")
            except Exception as e:
                messages.error(request, f"Hubo un error al enviar el correo: {e}")
